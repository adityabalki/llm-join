...
def test_invalid_llm_threshold():
    with pytest.raises(ValueError):
        ColumnConfig(left_col="a", right_col="b", embed_fn=dummy_embed, context=CTX, llm_threshold=1.5)
...
def test_invalid_embed_skip_threshold():
    with pytest.raises(ValueError):
        ColumnConfig(left_col="a", right_col="b", embed_fn=dummy_embed, context=CTX, embed_skip_threshold=1.5)
